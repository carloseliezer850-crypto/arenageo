...
export function FiltrosPartida({ matches, sports, skillLevels }: FiltrosPartidaProps) {
      ...
      <div className="cards-grid">
        {filteredMatches.length === 0 ? (
          <div className="empty-state">
            ...
            <p>Não há partidas disponíveis para os filtros selecionados.</p>
          </div>
          ...
          return (
            <article key={match.id} className="match-card">
              ...
              <div className="card-footer">
                ...
                <a href={`/partidas/${match.id}`} className="text-link">Ver partida</a>
              </div>
            </article>
          );
        })}
