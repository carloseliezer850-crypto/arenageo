  ...
  return (
    <div className="route-stack account-selection-shell">
      ...
      <div className="inline-actions justify-center">
        {selected === "player" ? (
          <a href="/cadastro/jogador" className="primary-button">Continuar como jogador</a>
        ) : null}
        {selected === "business" ? (
          <a href="/cadastro/empresa" className="primary-button">Continuar como comerciante</a>
        ) : null}
      </div>
    </div>
  );
