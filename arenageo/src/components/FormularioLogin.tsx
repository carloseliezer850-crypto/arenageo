...
import type { LoginRequest } from "@/types/autenticacao";
import { entrar } from "@/services/servicoAutenticacao";
...
export function FormularioLogin() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      const result = await entrar(form);
  ...
  return (
    <div className="entrar-shell">
      <div className="entrar-visual">
        <div className="entrar-visual-inner">
      ...
      <div className="auth-panel">
        ...
        <form className="auth-form" onSubmit={handleSubmit} noValidate>
          ...
          <div className="checkbox-row">
            ...
            <a href="/cadastro" className="text-link">Esqueci minha senha</a>
          </div>
          ...
          <a href="/cadastro" className="secondary-button button-link auth-button secondary-auth-button">Criar conta</a>
